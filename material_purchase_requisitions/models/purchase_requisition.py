...
class MaterialPurchaseRequisition(models.Model):
    ...
    state = fields.Selection([
        ('draft', 'Nuevo'),
        ('dept_confirm', 'Aprobacion Departmento'),
        ('ir_approve', 'Esperando Aprobacion'),
        ('approve', 'Aprobado'),
...
#                            }
                ...
                if line.requisition_type == 'subcontratista': #mbj
                    if not line.partner_id:
                        raise Warning(_('Por favor ingresar un Subcontratista'))
                    for partner in line.partner_id:
                        if partner not in po_dict:
                            po_vals = {
                                'partner_id':partner.id,
