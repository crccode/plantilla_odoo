...
class ReportGeneralLedger(models.AbstractModel):
    ...
    def _get_account_move_entry(self, accounts, init_balance, sortby, display_account, abc):
        """
        :param:
    ...
    def _get_report_values(self, docids, data=None):
        ...
        accounts_res = self.with_context(data['form'].get('used_context',{}))._get_account_move_entry(accounts, init_balance, sortby, display_account, abc)
        return {
            'doc_ids': docids,
            'doc_model': model,
            'data': data['form'],
